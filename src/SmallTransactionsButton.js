...
export class SmallTransactionsButton extends React.Component
{
  render()
  {
    ...
    return (
      <button className="smalltransaction" data-direction={this.props.direction} data-amount={this.props.amount} onClick={e => this.props.onClick(e.target)} className="smallTransactions">
